...
export interface IntuRankXpBadgeProps {
  ...
  /** Optional rank number from the leaderboard â€” rendered as a small chip. */
  rank?: number | null;
  /** When true, hides the breakdown line (Arena Â/ Activity). Useful in tight spaces. */
  compact?: boolean;
  className?: string;
  /** Shown when the connected wallet hasn't loaded yet â€” keeps layout stable. */
  loading?: boolean;
  /** Light card for blueprint / Climb contest shell. */
  surface?: 'dark' | 'light';
  /** Arcade HUD frame for Climb header â€” bolder glass, glow, larger token. */
