...
/**
 * Cards added during Curate/Rank get a `pending-card-â€¦` id (session-local deck
 ...
 * This modal validates the input, builds a `RankItem` with a `pending-card-â€¦` id, and hands it
 * back for ranking UX only â€” no wallet calls from this modal.
 */
