/**
 * Compact Arena leaderboard glance â€” top 3 + your rank + CTA to full board.
 *
        ...
        <div className="px-3.5 pb-3">
          ...
          >
            ...
            <div className="text-right shrink-0 space-y-1.5 tabular-nums">
              <div title="Arena XP â€” indexer plus device pick credit until the graph catches up (matches Climb uplink).">
              ...
              <div title="Activity XP â€” this browser for you; others from API mirror when deployed.">
