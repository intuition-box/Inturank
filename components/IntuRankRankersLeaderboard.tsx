...
const HINT_XP =
  'Ranks by **total IntuRank XP**: Arena (indexed ranks) + Activity (markets, creates, sends) + Gifts (team-granted, server-verified). Others’ activity counts when mirrored from the API; yours includes this browser.';
