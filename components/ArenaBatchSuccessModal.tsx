...
export type ArenaBatchSuccessPayload = {
  ...
  /** e.g. `Wallet â€” YES for "Owl" in "Animal Archetype"` */
  humanLine?: string;
  /** Shown when optional attestation failed but stakes succeeded. */
  footnote?: string;
  /**
   * Protocol activity points (XPDN) from this batch â€” local ledger via `notifyProtocolXpEarned` / add_to_list.
   */
  ...
  xpdnByTx?: number[];
  /** Optional replacement for the default â€œArena stancesâ€ footer line (e.g. Signal / Pulse). */
  outro?: string;
};
